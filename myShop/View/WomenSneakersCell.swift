...
class SneakersProductCell: UICollectionViewCell {
    ...
    func setupRedHeartButton() {
        ...
        heartRedButton.addTarget(self, action: #selector(actionRedButton), for: .touchUpInside)
    }
    
    @objc func actionRedButton() {
        heartWhiteButton.isHidden = false
        heartRedButton.isHidden = true
    }
