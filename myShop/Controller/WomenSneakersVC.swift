...
class WomenSneakersVC: UIViewController {

    var sneakersArray = ProductWomen.Womenproduct
    var identifier = "Cell"
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(SneakersProductCell.self, forCellWithReuseIdentifier: identifier)
